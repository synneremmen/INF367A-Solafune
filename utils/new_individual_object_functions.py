...
class Generator:
    def __init__(self, batch_size, masked_images=None, images=None, subset=False, min_area=1000):
        ...
        self.extracted_objects = self._extract_objects(images=images, min_area=min_area, subset=subset)
    ...
    def _extract_objects(self, images=None, min_area=100, subset=False): # ikke laste opp alle bildene for å unngå å ta opp så mye plass?
        """
    ...
    def _crop_target_object(self, object_id: int):
        ...
        # crop the target object from image
    ...
    def _apply_object_augmentation(self, name, background, mask):
        ...
        #     cropped_obj, cropped_mask = self._crop_target_object(target_ids[0]) 
...
def create_OBA_dataset(
    ...
    Args:
        ...
        base_augm (bool): Whether to apply base augmentation.
